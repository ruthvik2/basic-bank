...
$row2=$res2->fetch_row();
   ...
   if($amt > $row1['5'])
  {
   ...
   else
    {
       ...
       $sac = $row1['1'];
       $rac = $row2['1'];
       $linknew=new mysqli("localhost","root","","bg") or die("DATA NOT FOUND");
    ...
    .msg
 {
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg mb-3">
    ...
    <a href="#" class="navbar-brand">
      ...
      <!-- Logo Text -->
      <span class="text-uppercase font-weight-bold">BG BANK</span>
    </a>
  ...
  <?php
  $link1=new mysqli("localhost","root","","bg") or die("DATA NOT FOUND");
  ...
  $link2=new mysqli("localhost","root","","bg") or die("DATA NOT FOUND");
